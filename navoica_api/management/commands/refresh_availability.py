    ...
    def handle(self, *args, **options):
        for course in modulestore().get_courses():
            ...
            if course_overview_model:
                ...
                if not (course_metadata_copy['other_course_settings']['value'].get('availability') and course_metadata_copy['other_course_settings']['value'].get('availability')==availability_status):
                    if availability_status:
                        ...
                        if course_metadata_copy['other_course_settings']['value'].get('availability'):
                            ...
                            update_flag = True
                    if update_flag:
                        other_course_settings_dict = simplejson.loads(simplejson.dumps({'other_course_settings': course_metadata_copy['other_course_settings']}, cls=ExtendedJSONEncoder))
